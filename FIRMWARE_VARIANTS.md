...
| `firmware_32_preloaded-music-vol35.bin` | 22 | ✓ Optional | fw_22 with vEEPROM page appended: `vol=35, bass=8, modeExtend=1, mode=Music`. Bar boots into those settings on first flash. Hasn't yet been rebuilt on fw_34 base — would be straightforward. |
